...
for (m in seq){
  ...
  true.lin.pred <- as.matrix(dat.pa[,1:p]) %*% beta + 0.3*as.matrix(dat.pa[,139])*as.matrix(dat.pa[,141]) - 0.3*as.matrix(dat.pa[,141])^2 + 0.2*as.matrix(dat.pa[,139])*as.matrix(dat.pa[,144])*as.matrix(dat.pa[,147]) - 0.4*as.matrix(dat.pa[,140])*as.matrix(dat.pa[,142])*as.matrix(dat.pa[,143])+1.6

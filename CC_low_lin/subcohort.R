...
path.test <- "/nas/longleaf/home/haolin/dissertation1/round2/data/test/"
#path.c <- "/nas/longleaf/home/haolin/dissertation1/round2/data/c/"
#path.r <- "/nas/longleaf/home/haolin/dissertation1/round2/data/r/"
#path.cc <- "/nas/longleaf/home/haolin/dissertation1/round2/data/cc/"
path.sc <- "/nas/longleaf/home/haolin/dissertation1/round2/data/sc/"
path.results <- "/nas/longleaf/home/haolin/dissertation1/round2/results/"
...
for (m in seq){
  ...
  true.lin.pred <- as.matrix(dat.pa[,1:p]) %*% beta #+ 0.3*X[,1]*X[,3] + 0.2*X[,3]^2 + 0.2*X[,1]*X[,6]*X[,9]
